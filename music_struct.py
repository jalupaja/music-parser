...
class song:
    def __init__(self, title, playlist_name="", artists="", genre="", url="", url_type="", yt_link="", year=""):
        self.title = title
    ...
    def get_values(self):
        return [self.playlist_name.replace('\'', '’'), self.title.replace('\'', '’'), self.artists.replace('\'', '’'), self.genre.replace('\'', '’'), self.url.replace('\'', '’'), self.url_type.replace('\'', '’'), self.yt_link.replace('\'', '’'), self.year.replace('\'', '’')]
